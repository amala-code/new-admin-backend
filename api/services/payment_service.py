    ...
    async def verify_payment(self, payment_data: PaymentVerification):
        try:
            ...
            if generated_signature == payment_data.razorpay_signature:
                ...
                # 'invoice_id': None, 'international': False, 'method': 'upi', 'amount_refunded': 0, 'refund_status': None, 
                # 'captured': True, 'description': 'Annual Membership Subscription', 'card_id': None, 'bank': None, 'wallet': None, 
                # 'vpa': '8839762419-2@axl', 'email': None, 'contact': '+919300079077', 'notes': [], 'fee': 2, 'tax': 0, 'error_code': None, 
                # 'error_description': None, 'error_source': None, 'error_step': None, 
                # 'error_reason': None, 'acquirer_data': {'rrn': '175081101588'}, 'created_at': 1758629082, 
                # 'upi': {'payer_account_type': 'bank_account', 'vpa': '8839762419-2@axl'}}
